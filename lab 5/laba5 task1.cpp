...
int main() {
    ...
    E = pow(2, exponent - 1) - 1; //стандартное смещение
    ...
    if ((n1 + E) > (pow(2, grid - mantissa - 1) - 1)) { //проверяем влазит ли в экспоненту
    ...
    floatingPoint = floatingPoint + "." + theExhibitor + "." + mantiss_string;
